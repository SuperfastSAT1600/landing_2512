...
ONTOLOGY  = Path("/workspace/master_sat_ontology_v3.jsonl")
VOCAB_MASTER = Path("/workspace/blog_database/vocab_master.json")
OUTPUT    = Path("/workspace/sat_vocab_book.jsonl")
