...
function AccessGateInner({ children }: { children: React.ReactNode }) {
  const searchParams = useSearchParams();
  const isLeadMode = searchParams.get('mode') === 'lead';
  return <AccessGateContent isLeadMode={isLeadMode}>{children}</AccessGateContent>;
}
...
function AccessGateContent({ children, isLeadMode }: { children: React.ReactNode; isLeadMode: boolean }) {
