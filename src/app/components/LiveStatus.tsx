...
const MESSAGES: Message[] = [
    ...
    { text: '*** 학생이 Vocab Adventure를 완료했습니다', type: 'green' },
    { text: '*** 학생이 Vocab Study를 완료했습니다', type: 'green' },
    { text: '*** 학생이 StudyHall에 접속하였습니다', type: 'green' },
    { text: '*** 학생이 Test Center에 접속하였습니다', type: 'green' },
