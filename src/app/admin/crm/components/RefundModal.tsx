      ...
      <div className="w-full max-w-sm bg-gray-50 rounded-xl border border-gray-200 shadow-2xl">
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-200">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-sm font-bold text-gray-900">환불 처리</h2>
          </div>
        ...
        <div className="flex items-center justify-end gap-2 px-5 py-4 border-t border-gray-200">
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-bold text-white bg-orange-500 hover:bg-orange-400 disabled:opacity-50 rounded-lg transition-colors"
          >
