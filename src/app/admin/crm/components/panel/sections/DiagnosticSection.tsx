          ...
          <div className="relative">
            ...
            >
              <span className="flex items-center gap-2 min-w-0">
                {stage != null && (
                  <span className="shrink-0 inline-flex items-center justify-center w-5 h-5 rounded-full bg-blue-100 text-blue-700 text-[11px] font-semibold">
                    {stage}
                  </span>
                )}
              ...
              <div className="mt-1 w-full rounded-xl border border-gray-200 bg-white overflow-hidden">
                {DIAGNOSTIC_FUNNEL_STAGES.map(s => {
                  ...
                  return (
                    ...
                    >
                      <span className={`shrink-0 inline-flex items-center justify-center w-5 h-5 rounded-full text-[11px] font-semibold ${
