...
import { buildTargetVsActual, niceAxisTicks, sliceRecentMonths, USD_TO_KRW_RATE, type MonthlyTargetRow } from '@/lib/business-targets';
...
export function GlobalSalesPanel({ adminKey }: Props) {
  ...
  const targetVsActual = sliceRecentMonths(buildTargetVsActual(monthlyTargets, actualByMonth)).map((row) => ({
    ...row,
