...
export function StudentSearch({ onSelect }: Props) {
  ...
  return (
    <div className="relative mb-6">
      <div className="flex items-center gap-2 bg-white border border-gray-200 rounded-lg px-3 py-2 focus-within:border-blue-500 transition-colors">
          ...
          {filtered.map((s) => (
            <li key={s.crmStudentId}>
              ...
              >
                ...
                {!s.sfv2ProfileId && (
                  <span className="text-[11px] text-gray-400 ml-auto">v2 미연결</span>
                )}
              </button>
            </li>
          ))}
