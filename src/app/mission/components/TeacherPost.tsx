      ...
      {isStory ? (
        <div className="flex justify-center">
          <a
            ...
            className="flex items-center gap-2 px-5 py-3 bg-gradient-to-r from-orange-400 to-pink-500 text-white text-sm font-semibold rounded-2xl shadow hover:opacity-90 transition-opacity"
          >
